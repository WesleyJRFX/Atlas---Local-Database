---
name: message-broker-engineering
description: >
  Use for queues, brokers, pub/sub, RabbitMQ, Kafka, NATS, topics, routing keys, acknowledgements, retries, and dead-letter handling.
---

# Message Broker Engineering
