---
name: playwright-e2e-engineering
description: >
  Use for Playwright E2E tests, selectors, fixtures, browser contexts, traces, screenshots, flake reduction, and UI flow automation.
---

# Playwright E2e Engineering
