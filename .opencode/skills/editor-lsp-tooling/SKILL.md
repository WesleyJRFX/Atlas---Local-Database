---
name: editor-lsp-tooling
description: >
  Use for editor configuration, LSP issues, tsserver, language servers, workspace settings, code intelligence, and developer experience.
---
