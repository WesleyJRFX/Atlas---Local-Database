...
description: >
  Use for GraphQL schemas, resolvers, queries, mutations, subscriptions, dataloaders, authorization, and GraphQL performance.
---

# Graphql Engineering

## Focus
Design GraphQL changes with schema clarity, resolver safety, and query performance.

## Checks
- Validate auth per field/mutation where needed.
- Avoid N+1 with batching/dataloaders.
- Preserve schema compatibility unless breaking change requested.
## Activation Rule
