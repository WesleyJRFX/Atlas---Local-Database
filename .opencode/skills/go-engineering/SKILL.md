...
name: go-engineering
description: >
  Use for Go services, modules, tests, concurrency, contexts, errors, interfaces, HTTP handlers, and Go build tooling.
---

# Go Engineering

## Focus
Write simple idiomatic Go with explicit errors, context-aware operations, and small interfaces.

## Checks
- Run gofmt/go test where possible.
- Do not ignore errors.
- Respect context cancellation and avoid goroutine leaks.
## Activation Rule
