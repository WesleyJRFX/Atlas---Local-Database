---
name: elasticsearch-opensearch-engineering
description: >
  Use for Elasticsearch/OpenSearch, indexing, analyzers, mappings, queries, aggregations, relevance, pagination, and search cluster issues.
---

# Elasticsearch Opensearch Engineering
