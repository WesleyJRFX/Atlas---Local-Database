---
name: stream-processing-engineering
description: >
  Use for streaming data, Kafka-like flows, event time, windows, offsets, consumers, backpressure, exactly-once/idempotent processing, and lag debugging.
---
