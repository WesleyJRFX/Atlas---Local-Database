---
name: mock-service-worker-testing
description: >
  Use for MSW, mocked APIs, browser/node request handlers, test fixtures, realistic network failures, and frontend integration testing.
---
