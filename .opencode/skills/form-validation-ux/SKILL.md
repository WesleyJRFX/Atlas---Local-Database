...
description: >
  Use for forms, validation messages, submit flows, dirty state, disabled buttons, field errors, async validation, and user input UX.
---

# Form Validation Ux

## Focus
Make forms safe, clear, and hard to misuse.

## Checks
- Validate client for UX and server for trust.
- Show field-level and form-level errors.
- Prevent double submit and preserve user input on errors.
## Activation Rule
