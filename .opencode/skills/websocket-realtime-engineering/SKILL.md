---
name: websocket-realtime-engineering
description: >
  Use for WebSocket, SSE, realtime events, subscriptions, presence, live updates, reconnects, heartbeats, and streaming UI.
---

# Websocket Realtime Engineering

## Focus
Build realtime flows that reconnect safely, clean up subscriptions, and avoid duplicate events.

## Checks
- Define event names and payloads.
- Handle auth, reconnect, backpressure, ordering, and cleanup.
