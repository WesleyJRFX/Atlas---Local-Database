---
name: shell-powershell-scripting
description: >
  Use for Windows PowerShell scripts, shell automation, path handling, quoting, process execution, file operations, and cross-platform command issues.
---

# Shell Powershell Scripting

## Focus
Write safe shell scripts that handle spaces, errors, paths, encodings, and exit codes.

## Checks
- Quote paths with `-LiteralPath` where possible.
- Verify parent directories before creating files.
- Avoid destructive wildcards and interactive prompts.
## Activation Rule
