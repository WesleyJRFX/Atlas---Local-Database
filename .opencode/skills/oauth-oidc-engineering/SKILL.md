---
name: oauth-oidc-engineering
description: >
  Use for OAuth2/OIDC, authorization code flow, PKCE, refresh tokens, scopes, identity providers, callback URLs, and auth integration.
---

# Oauth Oidc Engineering
