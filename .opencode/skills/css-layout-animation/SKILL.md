...
description: >
  Use for CSS layout, Grid/Flexbox, responsive spacing, animations, transitions, theming, visual bugs, and cross-browser styling.
---

# Css Layout Animation

## Focus
Create maintainable CSS with scoped selectors, predictable layout, and performant animation.

## Checks
- Prefer Grid/Flex over fragile absolute offsets.
- Animate transform/opacity when possible.
- Define overflow, focus, disabled, and reduced-motion behavior.
## Activation Rule
