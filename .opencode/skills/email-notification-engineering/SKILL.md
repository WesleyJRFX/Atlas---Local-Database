---
name: email-notification-engineering
description: >
  Use for emails, notifications, templates, delivery, unsubscribe, retry, event triggers, and user communication flows.
---

# Email Notification Engineering

## Focus
Send correct notifications once, with safe content and reliable delivery handling.

## Checks
- Avoid duplicate sends.
- Respect opt-out/unsubscribe where relevant.
- Validate template variables and fallback text.
## Activation Rule
