---
name: php-laravel-engineering
description: >
  Use for PHP and Laravel code, routes, controllers, Eloquent, migrations, Blade, queues, validation, and composer workflows.
---

# Php Laravel Engineering

## Focus
Follow Laravel/PHP conventions for validation, authorization, models, migrations, and tests.

## Checks
- Use FormRequest/policies where project does.
- Avoid mass assignment risks.
- Run composer/phpunit/artisan checks where available.
## Activation Rule
