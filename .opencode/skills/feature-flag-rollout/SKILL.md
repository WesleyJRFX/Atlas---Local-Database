...
description: >
  Use for feature flags, gradual rollout, experiments, kill switches, staged releases, dark launches, and backwards compatibility.
---

# Feature Flag Rollout

## Focus
Gate risky behavior safely and make rollout reversible.

## Checks
- Define default/off behavior.
- Avoid flags that permanently fork logic without cleanup plan.
