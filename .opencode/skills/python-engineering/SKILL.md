...
description: >
  Use for Python code, scripts, packages, virtual environments, pytest, typing, async Python, CLI tools, data processing, and Python build/test issues.
---

# Python Engineering

## Focus
Write idiomatic Python with clear functions, type hints where project uses them, robust errors, and testable design.

## Checks
- Respect formatter/linter/project layout.
- Use pathlib for paths where suitable.
- Avoid broad except blocks and mutable default traps.
## Activation Rule
