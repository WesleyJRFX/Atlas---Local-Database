---
name: polish-polls-data-scraping
description: >
  Use for polish-polls scraper/debug scripts, Cheerio/RSS/parsing, polling data ingestion, party names, encoding, duplicate prevention, and validating external political data sources.
---

# Polish Polls Data Scraping
