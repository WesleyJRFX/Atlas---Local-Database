---
name: java-kotlin-engineering
description: >
  Use for Java/Kotlin applications, Spring, Gradle/Maven, JVM tests, null safety, services, APIs, and enterprise backend code.
---

# Java Kotlin Engineering

## Focus
Keep JVM code layered, typed, testable, and consistent with framework conventions.

## Checks
- Respect dependency injection and package structure.
- Validate DTOs at boundaries.
- Run relevant Gradle/Maven tests when possible.
## Activation Rule
