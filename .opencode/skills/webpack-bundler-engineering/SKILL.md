---
name: webpack-bundler-engineering
description: >
  Use for Webpack, loaders, plugins, module resolution, chunking, dev server, asset handling, and legacy bundler issues.
---

# Webpack Bundler Engineering
