---
name: config-environment-management
description: >
  Use for environment variables, config files, secrets references, local/prod differences, defaults, validation, and configuration bugs.
---

# Config Environment Management

## Focus
Centralize and validate configuration without hardcoding machine-specific values.

## Checks
- Use existing config loader.
- Provide safe defaults only where appropriate.
- Update env examples/docs without exposing secrets.
## Activation Rule
