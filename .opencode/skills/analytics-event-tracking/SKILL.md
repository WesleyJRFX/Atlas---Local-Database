...
description: >
  Use for analytics events, telemetry, product metrics, tracking plans, privacy-safe instrumentation, and event naming consistency.
---

# Analytics Event Tracking

## Focus
Instrument meaningful events without leaking private data or polluting metrics.

## Checks
- Define event name, trigger, properties, and privacy level.
- Avoid duplicate events on rerender/retry.
