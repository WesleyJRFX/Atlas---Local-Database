...
description: >
  Use for multi-step coding tasks, large fixes, feature implementation, migrations, or any work that needs planning, sequencing, and progress tracking.
---

# Task Planning Execution

## Focus
Break work into actionable steps, keep one active step at a time, and update plan when discoveries change scope.

## Checks
- Define investigation, implementation, and verification phases.
- Use todos for 3+ meaningful steps.
- Avoid doing unrelated cleanup while executing plan.
## Activation Rule
