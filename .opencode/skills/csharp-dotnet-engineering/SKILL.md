...
description: >
  Use for C#/.NET projects, ASP.NET, Entity Framework, LINQ, async/await, csproj, tests, and build issues.
---

# Csharp Dotnet Engineering

## Focus
Write clear .NET code with proper async, DI, validation, and disposal.

## Checks
- Avoid sync-over-async.
- Use cancellation tokens where project pattern supports them.
- Run dotnet build/test where possible.
## Activation Rule
