...
description: >
  Use for application state, stores, reducers, contexts, signals, cache state, synchronization, stale data, and cross-component data flow.
---

# State Management Data Flow

## Focus
Keep state ownership clear and avoid stale/duplicated state.

## Checks
- Identify source of truth.
- Separate server cache, UI state, form state, and derived values.
- Handle reset/cleanup on navigation/logout/unmount.
## Activation Rule
