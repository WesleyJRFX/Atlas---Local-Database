---
name: bug-reproduction-minimization
description: >
  Use when a bug must be reproduced, reduced to minimal case, isolated from noise, or converted into a regression test.
---

# Bug Reproduction Minimization

## Focus
Find the smallest reliable reproduction. Separate trigger, environment, data, and expected behavior.

## Checks
- Capture exact command/input/state.
- Remove unrelated variables.
- Preserve a regression test or manual repro steps.
## Activation Rule
