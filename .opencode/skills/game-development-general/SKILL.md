---
name: game-development-general
description: >
  Use for general game development, loops, state machines, input, UI/HUD, physics integration, save systems, assets, and runtime performance.
---
