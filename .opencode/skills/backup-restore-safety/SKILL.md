---
name: backup-restore-safety
description: >
  Use for backups, restores, migrations with rollback risk, data deletion, export snapshots, recovery scripts, and destructive operational tasks.
---

# Backup Restore Safety

## Focus
Protect data before destructive or irreversible operations.

## Checks
- Ask confirmation for destructive actions.
- Verify target paths/environments.
- Prefer dry-run and backup before delete/overwrite/restore.
## Activation Rule
