...
description: >
  Use for old code, technical debt, deprecated APIs, modernization, incremental migration, compatibility preservation, and strangler patterns.
---

# Legacy Code Modernization

## Focus
Modernize incrementally without breaking existing users.

## Checks
- Identify public behavior and hidden dependencies.
- Add tests around legacy behavior before changing risky code.
- Keep compatibility shims when needed.
## Activation Rule
