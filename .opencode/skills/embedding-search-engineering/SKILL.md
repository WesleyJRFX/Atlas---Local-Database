---
name: embedding-search-engineering
description: >
  Use for embedding generation, semantic search, similarity metrics, vector indexes, metadata filters, deduplication, and search relevance tuning.
---

# Embedding Search Engineering
