---
name: vite-bundler-engineering
description: >
  Use for Vite, dev server, plugins, HMR, build output, assets, aliases, env variables, and Vite troubleshooting.
---

# Vite Bundler Engineering
