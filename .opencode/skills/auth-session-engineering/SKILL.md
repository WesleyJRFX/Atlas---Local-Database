---
name: auth-session-engineering
description: >
  Use for login, sessions, JWT, cookies, OAuth, password reset, MFA, roles, permissions, logout, CSRF, and auth bugs.
---

# Auth Session Engineering

## Focus
Keep authentication and authorization correct, secure, and user-friendly.

## Checks
- Server validates identity and permission.
- Cookies/tokens have safe lifetime/storage/samesite/secure flags where applicable.
- Logout/session expiry clears client state.
## Activation Rule
