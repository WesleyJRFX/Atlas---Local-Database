---
name: cli-tooling-automation
description: >
  Use for creating or modifying CLI commands, scripts, developer tools, generators, codemods, automation helpers, and command-line UX.
---

# Cli Tooling Automation

## Focus
Build reliable CLI tools with clear args, safe defaults, useful errors, and non-interactive automation support.

## Checks
- Validate arguments and paths.
- Add dry-run/confirmation for destructive operations when useful.
- Make output scriptable and human-readable.
## Activation Rule
