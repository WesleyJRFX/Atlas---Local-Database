...
description: >
  Use for REST contracts, OpenAPI/Swagger specs, request/response schemas, API docs, client generation, and contract drift.
---

# Api Contract Openapi

## Focus
Keep API implementation, validation, docs, and clients aligned.

## Checks
- Define status codes and error shape.
- Keep examples real.
- Update generated clients/specs when contract changes.
## Activation Rule
