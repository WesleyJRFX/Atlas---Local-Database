...
description: >
  Use for Windows/Linux/macOS path, shell, newline, filesystem case-sensitivity, browser compatibility, runtime differences, and portability bugs.
---

# Cross Platform Compatibility

## Focus
Avoid assumptions tied to one OS/runtime/browser.

## Checks
- Quote paths and use path join APIs.
- Avoid case-only filename changes without care.
- Consider shell syntax differences and line endings.
## Activation Rule
