...
description: >
  Use for background jobs, queues, workers, cron, schedulers, retries, idempotency, delayed tasks, and async processing.
---

# Background Jobs Queues

## Focus
Make background work idempotent, observable, and bounded.

## Checks
- Validate payloads at job boundary.
- Handle retries and dead-letter/final failure.
