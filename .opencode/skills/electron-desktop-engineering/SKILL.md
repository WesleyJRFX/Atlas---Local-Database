---
name: electron-desktop-engineering
description: >
  Use for Electron desktop apps, main/renderer process boundaries, preload scripts, IPC, packaging, auto-update, desktop security, and native integrations.
---

# Electron Desktop Engineering
