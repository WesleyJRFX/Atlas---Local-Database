---
name: runelab-riot-lcu-integration
description: >
  Use for RuneLab Riot/League LCU integration: lockfile discovery, HTTPS local API, auth tokens, champion select/live client data, polling, unavailable client states, and token secrecy.
---

# Runelab Riot Lcu Integration
