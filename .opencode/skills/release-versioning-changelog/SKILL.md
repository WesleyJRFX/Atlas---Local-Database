...
description: >
  Use for releases, semantic versioning, changelogs, release notes, migration notes, tagging, compatibility, and upgrade communication.
---

# Release Versioning Changelog

## Focus
Prepare clear releases with accurate version impact and user-facing notes.

## Checks
- Identify breaking/fix/feature/internal changes.
- Include migration and rollback notes when relevant.
- Do not tag/push unless explicitly requested.
## Activation Rule
