...
description: >
  Use for file uploads, downloads, images, documents, media processing, storage paths, MIME validation, size limits, and antivirus/safety checks.
---

# File Upload Processing

## Focus
Handle files as untrusted input with size/type/path safety.

## Checks
- Validate MIME and extension where useful.
- Prevent path traversal and executable upload risks.
- Clean temp files and handle partial failures.
## Activation Rule
