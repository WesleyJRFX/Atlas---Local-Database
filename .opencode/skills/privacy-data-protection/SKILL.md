...
description: >
  Use for personal data, GDPR-like concerns, redaction, retention, consent, data export/delete, logs containing PII, and privacy-safe features.
---

# Privacy Data Protection

## Focus
Minimize, protect, and redact personal data.

## Checks
- Collect only necessary data.
- Mask PII in logs/final answers unless explicitly needed.
- Respect retention/delete/export requirements where project has them.
## Activation Rule
