---
name: payment-billing-safety
description: >
  Use for payments, subscriptions, invoices, checkout, credits, refunds, billing webhooks, entitlements, and money-sensitive code.
---

# Payment Billing Safety

## Focus
Treat money and entitlements as high-risk server-authoritative state.

## Checks
- Verify webhook signatures.
- Make operations idempotent.
- Never trust client price/status.
- Log audit context without sensitive payment data.
## Activation Rule
