---
name: contract-testing-engineering
description: >
  Use for consumer/provider contract tests, Pact-like workflows, API compatibility, schema contracts, and integration boundary verification.
---

# Contract Testing Engineering
