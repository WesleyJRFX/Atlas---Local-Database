---
name: time-date-timezone
description: >
  Use for dates, times, time zones, durations, scheduling, expiration, daylight saving, calendars, and timestamp bugs.
---

# Time Date Timezone

## Focus
Make time behavior explicit and test edge cases.

## Checks
- Store UTC when appropriate.
- Convert at boundaries for display.
- Test DST, midnight, expiry, and timezone assumptions.
## Activation Rule
