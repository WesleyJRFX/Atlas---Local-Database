---
name: sourcemap-debugging
description: >
  Use for sourcemaps, minified stack traces, production error mapping, bundle debugging, release artifact matching, and frontend crash diagnosis.
---
