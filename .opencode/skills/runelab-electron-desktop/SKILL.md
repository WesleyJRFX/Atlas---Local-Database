---
name: runelab-electron-desktop
description: >
  Use for RuneLab desktop/Electron work: main/renderer/preload boundaries, IPC safety, packaging, auto-update, local files, and desktop app lifecycle.
---

# Runelab Electron Desktop
