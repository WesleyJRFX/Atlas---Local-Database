---
name: final-verification-handoff
description: >
  Use before final response after meaningful code changes to ensure verification, changed files, risks, and user test steps are complete.
---

# Final Verification Handoff

## Focus
Do final quality gate before saying done.

## Checks
- Confirm requested scope completed.
- Confirm tests/build/typecheck/manual checks.
- Summarize files changed and exact follow-up commands.
- Mention unverified parts honestly.
## Activation Rule
