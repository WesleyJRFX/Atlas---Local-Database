...
description: >
  Use for build errors, bundlers, compilers, transpilers, asset pipelines, module resolution, missing files, and production build failures.
---

# Build System Troubleshooting

## Focus
Diagnose build pipeline failures from config, entrypoints, loaders/plugins, paths, environment, and dependencies.

## Checks
- Reproduce with exact build command.
- Inspect config and package scripts.
- Fix root cause, not generated artifacts.
## Activation Rule
