...
description: >
  Use when defining done conditions for features, bugfixes, UI changes, tests, API behavior, or handoff quality.
---

# Acceptance Criteria Definition

## Focus
Translate requirements into verifiable acceptance criteria before implementation.

## Checks
- Include happy path, edge cases, errors, permissions, loading/empty states, and performance if relevant.
- Tie each criterion to test/manual verification.
- Use criteria to prevent scope creep.
## Activation Rule
