...
description: >
  Use for React components, hooks, props, state, effects, rendering performance, forms, context, and React test failures.
---

# React Component Engineering

## Focus
Build React components with clear props, stable state, safe effects, and accessible DOM.

## Checks
- Clean up effects.
- Avoid derived-state bugs and unnecessary rerenders.
