...
description: >
  Use for HTTP cache, server cache, memoization, Redis, CDN, browser cache, invalidation, stale data, and performance caching decisions.
---

# Caching Strategy

## Focus
Cache deliberately with clear keys, scope, TTL, and invalidation.

## Checks
- Do not cache permission-sensitive data globally.
- Define freshness and invalidation triggers.
- Avoid hiding correctness bugs behind cache.
## Activation Rule
