...
description: >
  Use for CSV/JSON/XML import/export, data mapping, validation, encoding, deduplication, batch processing, and report generation.
---

# Data Import Export

## Focus
Move data safely with validation, clear mapping, and recoverable failures.

## Checks
- Validate schema and encoding.
- Handle partial failures and duplicates.
- Avoid loading huge files fully when streaming/batching is needed.
## Activation Rule
