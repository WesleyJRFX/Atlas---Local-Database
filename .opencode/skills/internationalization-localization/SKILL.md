...
description: >
  Use for i18n/l10n, translation keys, locale formatting, pluralization, RTL, language switching, and avoiding hardcoded user-facing text.
---

# Internationalization Localization

## Focus
Keep text and formatting locale-aware.

## Checks
- Use existing translation system.
- Handle plural, gender/context where needed.
