...
description: >
  Use for accessibility review, keyboard navigation, ARIA, semantic HTML, focus management, contrast, screen reader behavior, and inclusive UI.
---

# Accessibility A11y Audit

## Focus
Make UI usable by keyboard and assistive tech without sacrificing design.

## Checks
- Semantic controls, labels, focus order, visible focus, contrast.
- ARIA only when needed and correct.
- No keyboard traps or inaccessible icon-only actions.
## Activation Rule
