---
name: nextjs-app-router-engineering
description: >
  Use for Next.js App Router, server/client components, route handlers, metadata, caching, server actions, SSR/SSG, and deployment issues.
---

# Nextjs App Router Engineering

## Focus
Respect Next.js server/client boundaries and caching semantics.

## Checks
- Add `use client` only when needed.
- Keep secrets server-side.
- Understand revalidate/dynamic/cache behavior before changing data fetching.
## Activation Rule
