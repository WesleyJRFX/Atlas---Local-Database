...
description: >
  Use for search, filtering, sorting, pagination, infinite scroll, query params, table/list UX, and backend list endpoints.
---

# Search Filter Pagination

## Focus
Make list retrieval predictable, bounded, and user-friendly.

## Checks
- Validate sort/filter fields.
- Add limits and stable ordering.
- Preserve query state and empty/loading/error UX.
## Activation Rule
