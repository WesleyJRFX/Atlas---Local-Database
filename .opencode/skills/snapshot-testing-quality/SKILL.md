---
name: snapshot-testing-quality
description: >
  Use for snapshot tests, approval tests, serializer updates, avoiding brittle snapshots, and reviewing intentional output changes.
---
