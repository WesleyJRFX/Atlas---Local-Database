...
description: >
  Use for race conditions, parallel requests, locks, stale callbacks, data races, async ordering, transactions, and multi-user conflicts.
---

# Concurrency Race Condition

## Focus
Make ordering, ownership, and idempotency explicit.

## Checks
- Identify shared state and concurrent actors.
- Use transactions/locks/tokens/versioning where project supports them.
- Handle stale/out-of-order results safely.
## Activation Rule
