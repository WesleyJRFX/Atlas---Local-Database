---
name: responsive-design-qa
description: >
  Use for responsive layouts, mobile/desktop breakpoints, ultrawide, viewport bugs, overflow, zoom, and adaptive UI verification.
---

# Responsive Design Qa

## Focus
Ensure UI works across realistic viewport sizes and content lengths.

## Checks
- Test small, normal, wide, and high zoom conditions.
- Handle wrapping/truncation intentionally.
- Avoid layout tied to one hardcoded screen.
## Activation Rule
