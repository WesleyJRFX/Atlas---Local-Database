...
description: >
  Use for memory growth, event/listener leaks, timers, subscriptions, caches, DOM leaks, handles not disposed, and long-running process leaks.
---

# Memory Leak Investigation

## Focus
Find retained resources and missing cleanup.

## Checks
- Inspect lifecycle create/destroy paths.
- Clean listeners, timers, intervals, observers, handles, streams, browser/DOM nodes.
