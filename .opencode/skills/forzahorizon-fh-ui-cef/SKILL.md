---
name: forzahorizon-fh-ui-cef
description: >
  Use for ForzaHorizon fh-ui CEF interfaces: HTML/CSS/JS mounted from Lua, browser lifecycle, focus/cursor state, postMessage/event bridge, and Forza-style UI fidelity.
---

# Forzahorizon Fh Ui Cef
