---
name: package-manager-workflows
description: >
  Use for npm, pnpm, yarn, bun, pip, poetry, cargo, go modules, lockfiles, installs, script execution, and package manager errors.
---

# Package Manager Workflows

## Focus
Use the package manager already chosen by the repo and keep lockfiles consistent.

## Checks
- Detect lockfile and workspace config.
- Do not mix managers.
- Prefer frozen/ci install semantics for verification where appropriate.
## Activation Rule
