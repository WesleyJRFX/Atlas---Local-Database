...
name: log-analysis
description: >
  Use for reading logs, stack traces, debug output, CI logs, server logs, browser console output, and event traces.
---

# Log Analysis

## Focus
Extract signal from logs and map it to responsible code.

## Checks
- Identify first meaningful error, not only final cascade.
- Note timestamps, request IDs, process names, file/line, error codes.
- Mask secrets and personal data in summaries.
## Activation Rule
