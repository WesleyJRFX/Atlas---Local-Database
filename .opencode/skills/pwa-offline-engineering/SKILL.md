---
name: pwa-offline-engineering
description: >
  Use for Progressive Web Apps, service workers, offline mode, cache strategies, manifests, installability, background sync, and web push constraints.
---
